...
export class ApiResponse<T = any> {
     ...
     * @param msg Error message, default is "Too many requests"
     * @param data Optional error data
     */
    static tooManyRequests<T = null>(msg: string = "Too many requests", data: T = null as T): ApiResponse<T> {
        return new ApiResponse(429, msg, data);
    }
